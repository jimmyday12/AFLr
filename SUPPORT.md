...
Thanks for using AFLr! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/jimmyday12/AFLr/issues/new).
...
requests](https://github.com/jimmyday12/AFLr/issues) to make sure the
