# Contributing to AFLr

This outlines how to propose a change to AFLr. For a detailed discussion
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("jimmyday12/AFLr", fork = TRUE)`.
...
Please note that the AFLr project is released with a [Contributor Code
of Conduct](https://jimmyday12.github.io/AFLr/CODE_OF_CONDUCT.md). By
